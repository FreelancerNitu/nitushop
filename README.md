...
Contributors: [Nitu Barmon](http://kevinbazira.com)
...
NituShop is a Gutenberg Ready WooCommerce Theme designed for Modern eCommerce Shops.

![NituShop Gutenberg Ready WooCommerce WordPress Theme](http://kevinbazira.com/images/articles/algori-shop-gutenberg-ready-woocommerce-wordpress-theme.jpg "NituShop Gutenberg Ready WooCommerce WordPress Theme")
...
* Type in NituShop in the search form and press the 'Enter' key on your keyboard.
...
NituShop includes support for the following plugins;
...
* Fixed WooCommerce Cart Widget CSS to blend well with the NituShop design
* Updated POT file in languages folder

= 1.0.9 - May 30 2019 =
* Fixed CSS for native WooCommerce Widgets to blend well with the NituShop design
* Added NituShop documentation link to the customizer
...
NituShop WooCommerce WordPress Theme, Copyright 2019 Kevin Bazira<br/>
NituShop is distributed under the terms of the GNU GPL<br/><br/>
