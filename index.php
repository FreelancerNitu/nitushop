        ...
        <main id="main" class="site-main col-sm-8 content">
          <div class="classic-blog">
            ...
            <ul class="products">
              <?php
										...
										if ( $loop->have_posts() ) {
											...
											echo __( 'No products found', 'nitu-shop' );
										}
										wp_reset_postdata();
									?>
            </ul>
            <!--/.products-->
            <a href="<?php esc_url( $shop_page_url ); ?>" class="button btn btn-block"
              aria-label="<?php esc_attr_e( 'View all products in shop', 'nitu-shop' ); ?>"><?php esc_html_e( 'View all products in shop', 'nitu-shop' ); ?></a>
            <?php
							else:
									if ( have_posts() ) :
            ...
            <?php
										...
										echo nitu_shop_get_the_posts_navigation();
