 ...
 */
function nitu_shop_register_required_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'nitu-shop',           // Unique ID for hashing notices for multiple instances of TGMPA.
...
add_action( 'tgmpa_register', 'nitu_shop_register_required_plugins' );