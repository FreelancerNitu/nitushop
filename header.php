...
<body <?php body_class('full-layout'); ?>>
  <div id="page" class="site body-wrapper">
    <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'nitu-shop' ); ?></a>
            ...
            <?php
					if (has_nav_menu('menu-1')) {
						wp_nav_menu( array(
							...
							'walker' => new nitu_shop_Walker_Nav_Primary()
						) );
					}
					?>

            <div class="nitu-shop-woocommerce-header-cart-link">
    ...
    <div class="header-hero">
      ...
      <div class="hero-info">
        ...
        <h1 class="hero-title"><?php esc_html_e( 'Welcome to ', 'nitu-shop' ); echo bloginfo( 'name' ); ?></h1>
        ...
        <div class="hero-btn">
          <?php
					...
					$display_cta_button = get_theme_mod( 'nitu_shop_display_cta_button', true );
					$cta_button_url = get_theme_mod( 'nitu_shop_cta_button_url', ( class_exists( 'WooCommerce' ) ) ? get_permalink( wc_get_page_id( 'shop' ) ) : '#' );
					$cta_button_text = get_theme_mod( 'nitu_shop_cta_button_text', __( 'Shop Now', 'nitu-shop' ) );
          ...
          <a href="<?php echo $cta_button_url ?>"
            class="btn btn-large nitu-shop-cta-button"><?php echo esc_html( $cta_button_text ); ?></a>
          <?php endif; ?>
        </div>
